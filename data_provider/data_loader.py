...
class Dataset_Custom(Dataset):
    ...
    def __read_data__(self):
        ...
        # record date
        years = df_stamp['date'].dt.year
        months = df_stamp['date'].dt.month
        days = df_stamp['date'].dt.day
    ...
    def __getitem__(self, index):
        ...
        date = self.date_array[s_begin:r_end]


        if self.set_type == 2:
            return seq_x, seq_y, seq_x_mark, seq_y_mark, date
        else:
            return seq_x, seq_y, seq_x_mark, seq_y_mark
